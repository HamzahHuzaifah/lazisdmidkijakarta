    ...
    <>
          ...
          <div className="row align-items-center">
            <div className="col-lg-6">
              ...
              <div className="d-flex gap-2">
                <button onClick={() => setHalaman('zakat')} className="btn btn-success btn-lg">Bayar Zakat</button>
                <button onClick={() => setHalaman('donasi')} className="btn btn-outline-secondary btn-lg">Donasi</button>
              </div>
            </div>
      ...
      <section className="py-5 bg-light">
          <div className="container text-center">
             ...
             <button onClick={() => setHalaman('donasi')} className="btn btn-link">Lihat Semua Program &rarr;</button>
          </div>
      </section>
    </>
  );
